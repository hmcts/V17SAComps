!(function (t, e) {
  ...
  function i(t, e) {
    ...
    for (var i in t) {
      ...
      if (Object.prototype.hasOwnProperty.call(t, i) && o[0] === e)
        o.length > 1 && o.shift(), (n[o.join('.')] = t[i]);
    }
    return n;
  }
  function o(t) {
  ...
  (function (t) {
        ...
        (function () {
          if (!window.Element || window.HTMLElement) {
            ...
            i.attachEvent('onpropertychange', function (t) {
              ...
              c() ||
                ((document.onreadystatechange = c), (t = setInterval(c, 25))),
    ...
    function (t) {
      (function () {
        ...
        return (
          t.setAttribute('data-a-b', 'c'), t.dataset && 'c' == t.dataset.aB
        );
      })() ||
    ...
    (r.prototype.replacePlaceholders = function (t, e) {
      var n;
      return (
        this.hasIntlNumberFormatSupport() &&
            ...
            (function () {
              ...
              if (
                ...
                t.classList.constructor.prototype.add = function () {
                  for (
                    var t = arguments, n = arguments.length, i = 0;
                    i < n;
                    i++
                  )
                    e.call(this, t[i]);
            ...
            i(
              ...
              function () {
                ...
                if (((r[a] = !0), !1 === n)) {
                  for (
                    var l,
                      c = o.mirror || document.createElement('div'),
                      u = c.childNodes,
                      d = u.length,
                      h = 0;
                    h < d;
  ...
  function l(t, e) {
    ...
    this.$module = t;
    var o = { i18n: a, rememberExpanded: !0 };
    (this.config = n(o, e || {}, s(t.dataset))),
    ...
    (l.prototype.constructHeaderMarkup = function (t, e) {
      ...
      if (n && i) {
        ...
        s.setAttribute('type', 'button'),
          s.setAttribute(
            'aria-controls',
            this.$module.id + '-content-' + (e + 1).toString(),
          );
  ...
  function u(t, e) {
    ...
    this.config = n({ preventDoubleClick: !1 }, e || {}, s(t.dataset));
  }
  (u.prototype.init = function () {
    ...
    function (t) {
      ('Date' in self &&
        'now' in self.Date &&
        'getTime' in self.Date.prototype) ||
        (Date.now = function () {
  ...
  function h(t, e) {
    ...
    var a,
      l,
      c,
      u = { threshold: 0, i18n: d },
      h = s(t.dataset),
      p = {};
    if (
      (('maxwords' in h || 'maxlength' in h) &&
        (p = { maxlength: !1, maxwords: !1 }),
      (this.config = n(u, e || {}, p, h)),
      (this.i18n = new r(i(this.config, 'i18n'), {
        locale:
          ((a = t),
          (l = 'lang'),
          (c = a.closest('[' + l + ']')),
          c ? c.getAttribute(l) : null),
      })),
  ...
  (h.prototype.init = function () {
    if (this.$module && this.$textarea) {
      ...
      if (e) {
        e.innerText.match(/^\s*$/) &&
          (e.innerText = this.i18n.t('textareaDescription', {
    ...
    (h.prototype.count = function (t) {
      return 'maxwords' in this.config && this.config.maxwords
        ? (t.match(/\S+/g) || []).length
        : t.length;
    }),
    ...
    (p.prototype.unCheckAllInputsExcept = function (t) {
      ...
      e(
        ...
        function (e) {
          t.form === e.form &&
            e !== t &&
            ((e.checked = !1), n.syncConditionalRevealWithInputState(e));
        },
      );
    }),
  ...
  function m(t, e) {
    if (!(t instanceof HTMLElement)) return this;
    this.$module = t;
    this.config = n({ disableAutoFocus: !1 }, e || {}, s(t.dataset));
  }
  ...
  (b.prototype.initUpdateSpan = function () {
    ...
    (b.prototype.updateIndicator = function () {
      this.keypressCounter > 0
        ...
        e(
          this.$indicatorContainer.querySelectorAll(
    ...
    (t.initAll = function (t) {
      var n =
        (t = void 0 !== t ? t : {}).scope instanceof HTMLElement
          ? t.scope
          : document;
      ...
      i && new m(i, t.errorSummary).init(),
        e(
          n.querySelectorAll('[data-module="govuk-exit-this-page"]'),
          function (e) {
